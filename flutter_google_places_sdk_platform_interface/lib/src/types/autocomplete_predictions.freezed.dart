...
/// @nodoc
abstract class _$$_AutocompletePredictionCopyWith<$Res>
    implements $AutocompletePredictionCopyWith<$Res> {
  factory _$$_AutocompletePredictionCopyWith(_$_AutocompletePrediction value,
          $Res Function(_$_AutocompletePrediction) then) =
      __$$_AutocompletePredictionCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? distanceMeters,
...
/// @nodoc
class __$$_AutocompletePredictionCopyWithImpl<$Res>
    extends _$AutocompletePredictionCopyWithImpl<$Res,
        _$_AutocompletePrediction>
    implements _$$_AutocompletePredictionCopyWith<$Res> {
  __$$_AutocompletePredictionCopyWithImpl(_$_AutocompletePrediction _value,
      $Res Function(_$_AutocompletePrediction) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_AutocompletePrediction(
      distanceMeters: freezed == distanceMeters
          ? _value.distanceMeters
          : distanceMeters // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$_AutocompletePrediction implements _AutocompletePrediction {
  const _$_AutocompletePrediction(
  ...
  factory _$_AutocompletePrediction.fromJson(Map<String, dynamic> json) =>
      _$$_AutocompletePredictionFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_AutocompletePrediction &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_AutocompletePredictionCopyWith<_$_AutocompletePrediction> get copyWith =>
      __$$_AutocompletePredictionCopyWithImpl<_$_AutocompletePrediction>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_AutocompletePredictionToJson(
      this,
    );
  }
}
...
abstract class _AutocompletePrediction implements AutocompletePrediction {
  const factory _AutocompletePrediction(
      ...
      required final String fullText}) = _$_AutocompletePrediction;

  factory _AutocompletePrediction.fromJson(Map<String, dynamic> json) =
      _$_AutocompletePrediction.fromJson;
